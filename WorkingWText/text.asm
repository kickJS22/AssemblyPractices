...
section .data ; Section to write memory
	whatiwant db "Hello I'm Juani, wtf is this", 0x0a ; 0x0a is the hex for 410, newline character. name db(define byte) text,0x0a
	len equ $ - whatiwant ; We substract the location after msg from inital location
...
_start:
	...
	mov ecx, whatiwant ; Indicates wich bytes we want to write
